...
if __name__ == '__main__':
    with suppress(KeyboardInterrupt):
        with suppress(IndexError):
            ...
            logger.info(
                f"{bcolors.FAIL}Send Packet To{bcolors.WARNING} %s{bcolors.FAIL} Dengan{bcolors.WARNING} %s{bcolors.FAIL} Methods Tools{bcolors.WARNING} %s{bcolors.FAIL} Dan Detik, Dan Thread:{bcolors.WARNING} %d{bcolors.FAIL}!!!{bcolors.RESET}"
